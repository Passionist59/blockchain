      ...
      <Row className='GroupTop'>
        ...
        <Col md={6} className='text-white second'>
          ...
          <Row className='buttonGroup_margin'>  
            <Col sm={6}><Button className='text-white button_1'>Action Button <HiOutlineArrowNarrowRight /></Button></Col>
            <Col sm={6}><Button className='text-white button_2'>Action Button <HiOutlineArrowNarrowRight /></Button></Col>
          </Row>
        </Col>
      </Row>
    </Container>
